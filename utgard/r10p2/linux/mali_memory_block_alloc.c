...
static mali_block_allocator *mali_mem_block_goal_allocator = NULL;
...
void mali_mem_block_allocator_destroy(void)
{
	...
	mali_block_allocator *info = mali_mem_block_goal_allocator;
...
_mali_osk_errcode_t mali_memory_core_resource_dedicated_memory(u32 start, u32 size)
{
	...
	mali_mem_block_goal_allocator = (mali_block_allocator *)allocator;
...
{
	return mali_mem_block_goal_allocator ? MALI_TRUE : MALI_FALSE;
}

u32 mali_mem_block_allocator_stat(void)
{
	mali_block_allocator *allocator = mali_mem_block_goal_allocator;
